class Background {
  constructor() {
    ...
    this.levelTwo = [
      ...
      {
        src: loadImage(
          "/Assets/background/lvl2/SpaceBackgrounds2_4_Nebula.png"
        ),
        x: 0,
        speed: 0
      },
      {
        src: loadImage(
          "/Assets/background/lvl2/SpaceBackgrounds2_4_Planet.png"
        ),
        x: 0,
        speed: 0.15
      },
    ...
    this.levelThree = [
      ...
      {
        src: loadImage(
          "/Assets/background/lvl3/SpaceBackgrounds2_5_Nebula.png"
        ),
        x: 0,
        speed: 0
      },
      {
        src: loadImage(
          "/Assets/background/lvl3/SpaceBackgrounds2_5_Planet.png"
        ),
        x: 0,
        speed: 0.2
      },
    ...
    this.levelFour = [
      ...
      {
        src: loadImage(
          "/Assets/background/lvl4/SpaceBackgrounds2_1_Nebula.png"
        ),
        x: 0,
        speed: 0.01
      },
    ...
    this.levelSix = [
      ...
      {
        src: loadImage(
          "/Assets/background/lvl6/SpaceBackgrounds2_6_Nebula.png"
        ),
        x: 0,
        speed: 0.02
      },
      {
        src: loadImage(
          "/Assets/background/lvl6/SpaceBackgrounds2_6_Planet.png"
        ),
        x: 0,
        speed: 0.3
      },
    ...
    this.levelFive = [
      ...
      {
        src: loadImage(
          "/Assets/background/lvl5/SpaceBackgrounds2_7_Nebula.png"
        ),
        x: 0,
        speed: 0.01
      },
      {
        src: loadImage(
          "/Assets/background/lvl5/SpaceBackgrounds2_7_Planet.png"
        ),
        x: 0,
        speed: 0.1
      },
